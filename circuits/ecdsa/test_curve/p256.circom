...
template GetP256Generator(CHUNK_SIZE,CHUNK_NUMBER){
    ...
    generator[0][0] <== 1399498261142;
    generator[0][1] <== 5937592964135;
    generator[0][2] <== 2044638659767;
    generator[0][3] <== 3791144493177;
    generator[0][4] <== 3041449184206;
    generator[0][5] <== 919922271682;
    generator[1][0] <== 447611884021;
    generator[1][1] <== 6785408267976;
    generator[1][2] <== 752572259756;
    generator[1][3] <== 6207268441867;
    generator[1][4] <== 1820960812670;
    generator[1][5] <== 686230455804;
}
