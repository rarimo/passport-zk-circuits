...
template SignedLineFunctionUnequalNoCarry(CHUNK_SIZE, CHUNK_NUMBER, M_OUT){
    ...
    for(var i=0; i<6; i++)for(var j=0; j<2; j++)for(var idx=0; idx<2*CHUNK_NUMBER-1; idx++){
        if( i==0 && j==0 ){
...
template SignedLineFunctionEqualNoCarry(CHUNK_SIZE, CHUNK_NUMBER, M_OUT){
    ...
    for(var i=0; i<6; i++)for(var j=0; j<2; j++)for(var idx=0; idx<3*CHUNK_NUMBER-2; idx++){
...
template Fp12MultiplyWithLineUnequal(CHUNK_SIZE, CHUNK_NUMBER, kg, OVERFLOW_G, q){
    ...
    for(var l=0; l<2; l++)for(var j=0; j<2; j++)for(var idx=0; idx<CHUNK_NUMBER; idx++)
    ...
    for(var i=0; i<6; i++)for(var j=0; j<2; j++)for(var idx=0; idx<2*CHUNK_NUMBER + kg - 2; idx++)
...
template TatePairing(CHUNK_SIZE, CHUNK_NUMBER, q){
    ...
    for(var i=0; i<2; i++)for(var l=0; l<6; l++)for(var j=0; j<2; j++)for(var idx=0; idx<CHUNK_NUMBER; idx++)
...
template Fp12MultiplyWithLineUnequalFp2(CHUNK_SIZE, CHUNK_NUMBER, kg, OVERFLOW_G, q){
    ...
    for(var i=0; i<2; i++)for(var j=0; j<2; j++)for(var l=0; l<2; l++)for(var idx=0; idx<CHUNK_NUMBER; idx++)
    ...
    for(var i=BIT_LENGTH - 1; i>=0; i--){
        if( i == BIT_LENGTH - 1 ){
            ...
            if(BITS[i] == 0){
                ...
                for(var eps=0; eps<2; eps++)for(var idx=0; idx<CHUNK_NUMBER; idx++)
