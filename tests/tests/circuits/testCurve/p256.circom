...
template GetP256Generator(CHUNK_SIZE,CHUNK_NUMBER){
    assert((CHUNK_SIZE == 32) && (CHUNK_NUMBER == 10));
    signal output generator[2][10];


    generator[0][0] <== 3633889942;
    generator[0][1] <== 4104206661;
    generator[0][2] <== 770388896;
    generator[0][3] <== 1996717441;
    generator[0][4] <== 1671708914;
    generator[0][5] <== 4173129445;
    generator[0][6] <== 3777774151;
    generator[0][7] <== 1796723186;
    generator[0][8] <== 0;
    generator[0][9] <== 0;
    generator[1][0] <== 935285237;
    generator[1][1] <== 3417718888;
    generator[1][2] <== 1798397646;
    generator[1][3] <== 734933847;
    generator[1][4] <== 2081398294;
    generator[1][5] <== 2397563722;
    generator[1][6] <== 4263149467;
    generator[1][7] <== 1340293858;
    generator[1][8] <== 0;
    generator[1][9] <== 0;
}
